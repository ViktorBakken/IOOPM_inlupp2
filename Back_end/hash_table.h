...
/// @brief Create a new hash table using appropriate eq_funcs for the keys and values, and a hash_func for the keys type
/// @param key_func func that is meant to compares two keys
/// @param value_func func that is meant to compares two values
/// @param hash_func func to hash a key
/// @return A new empty hash table with types depending on the inputs.
...
/// @brief Delete a hash table and free its memory, though not the memory of any pointer elements that may be on the heap
...
/// @return both a bool for if the succes and a value
/// @warning the return value need to be manually freed;
...
/// @param h hash table operated upon
/// @return a ioopm_list_t of keys for hash table h
ioopm_list_t *ioopm_hash_table_keys(ioopm_hash_table_t *ht);

/// @brief return the values for all entries in a hash map (in no particular order, but same as ioopm_hash_table_keys)
/// @param h hash table operated upon
/// @return a ioopm_list_t of values for hash table h
